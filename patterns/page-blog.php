...
<main class="wp-block-group alignfull site-content" id="page-title" style="margin-top:0"><!-- wp:cover {"url":"<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>pexels-erik-mclean-4140925.jpg","id":6842,"dimRatio":80,"gradient":"black-primary","align":"full"} -->
<div class="wp-block-cover alignfull"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-80 has-background-dim wp-block-cover__gradient-background has-background-gradient has-black-primary-gradient-background"></span><img class="wp-block-cover__image-background wp-image-6842" alt="" src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>pexels-erik-mclean-4140925.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"className":"is-style-default","layout":{"type":"constrained"}} -->
